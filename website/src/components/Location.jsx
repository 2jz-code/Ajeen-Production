	...
	return (
		<div className="flex items-start space-x-4 p-6 bg-primary-beige rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
			...
			<div>
				...
				{/* Details: Dark Brown */}
				<p className="text-accent-dark-brown">{details}</p>
			</div>
		</div>
	);
};
				...
				<div className="grid md:grid-cols-2 gap-8 mb-16">
					...
					<div className="relative rounded-xl overflow-hidden shadow-xl h-[400px] group">
						...
						<iframe
							...
							src="https://maps.google.com/maps?q=2105+Cliff+Rd+Suite+300,+Eagan,+MN,+55122&hl=es;z=14&amp;output=embed" // Using a direct embed link
							allowFullScreen=""
							loading="lazy"
							referrerPolicy="no-referrer-when-downgrade"
						></iframe>
						<a
							href="https://maps.google.com/maps?q=2105+Cliff+Rd+Suite+300,+Eagan,+MN,+55122" // Direct link to Google Maps
							target="_blank"
