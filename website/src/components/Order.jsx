...
const Order = () => {
  return (
    <div className="relative py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-primary-beige via-accent-warm-brown/40 to-accent-warm-brown/70"></div>

      {/* Updated decorative shapes using primary-green for subtle contrast on beige background */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-24 -right-24 w-72 h-72 md:w-96 md:h-96 bg-gradient-to-b from-primary-beige via-accent-warm-brown/40 to-primary-green opacity-10 rounded-full"></div>{" "}
