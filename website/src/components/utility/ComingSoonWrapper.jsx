	...
	return (
		<div className="relative group isolate">
			...
			{active && (
				...
				<div className="absolute inset-0 flex flex-col items-center justify-center bg-accent-dark-brown/70 backdrop-blur-sm rounded-md cursor-not-allowed z-10 p-4 text-center transition-all duration-300 ease-in-out">
