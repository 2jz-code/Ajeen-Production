...
export const productService = {
  ...
  addProduct: async (productData) => {
    try {
      const response = await axiosInstance.post(ENDPOINTS.PRODUCTS.ADD, productData);
      return response.data;
    } catch (error) {
  ...
  editProduct: async (name, productData) => {
    try {
      const response = await axiosInstance.put(ENDPOINTS.PRODUCTS.EDIT(name), productData);
      return response.data;
    } catch (error) {
  ...
  deleteProduct: async (name) => {
    try {
      const response = await axiosInstance.delete(ENDPOINTS.PRODUCTS.DELETE(name));
  ...
  getProductByBarcode: async (barcode) => {
    try {
      const response = await axiosInstance.get(`${ENDPOINTS.PRODUCTS.BY_BARCODE}?barcode=${barcode}`);
      return response.data;
    } catch (error) {
